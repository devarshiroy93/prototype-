...
var firstComponent  = Vue.component('login-reg',{
	'template':`<div>
				...
				<div class="row"><div class="col-sm-6"><input type="submit" name="login-submit" id="login-submit" tabindex="4" value="Log In with Google" class="form-control btn btn-login btn-success google-btn"></div>

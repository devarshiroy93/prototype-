                        ...
                        <img :src=postData.authorPic alt="Card image cap" class="img-responsive">
                         ...
                         <div class="col-md-10 col-sm-10 col-xs-10 col-lg-10">
                           ...
                           <div class="row caption col-md-12 col-sm-12 col-xs-12 likeSection">
                            ...
                            <a class="col-md-3 col-xs-4 col-sm-3 col-lg-3 comments"><i class="material-icons">chat_bubble_outline</i><span v-if="postData.commentCount>0"><b>{{postData.commentCount}} </b></span>Comment<span v-if ="postData.commentCount>1">s</span></a>

var messenger = Vue.component('messaging-comp',{
    template : `<div>
                <div class="messagingComp col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="col-md-4 col-lg-3 col-sm-4 hidden-xs col-xs-12 friendRequestPanel messageList scrollbar-customised"><div><span class="messageHeader subheader">Messages</span><span class="material-icons messageSearch" title="Search" v-on:click="showSearchBar">search</span></div>
                        <hr class="divider">
